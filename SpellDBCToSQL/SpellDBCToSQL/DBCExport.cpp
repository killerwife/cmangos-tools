...
void DBCExport::ExportDBCToSQLWotlk(std::string tableName)
{
...
void DBCExport::ExportDBCToSQLClassic(std::string tableName)
{
    //sLog.WaitBeforeContinueIfNeed();
...
void DBCExport::ExportDBCToSQLTBC(std::string tableName)
{
    //sLog.WaitBeforeContinueIfNeed();
...
void DBCExport::ExportFactionsTBC(std::string tableName)
{
    //sLog.WaitBeforeContinueIfNeed();
...
void DBCExport::ExportFactionsWOTLK(std::string tableName)
{
    //sLog.WaitBeforeContinueIfNeed();
